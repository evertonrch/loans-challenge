...
public class PersonalLoanStrategy implements LoanStrategy {
    ...
    public PersonalLoanStrategy(PersonalAndGuaranteedRule personalAndGuaranteedRule) {
    ...
    public Optional<LoanInfo> validate(CustomerRequest customerRequest) {
        ...
        if (income <= 3000.0 || validate(income, age, location)) {
    ...
    private boolean validate(double income, int age, String location) {
        return personalAndGuaranteedRule.validate(income, age, location);
    }
}
